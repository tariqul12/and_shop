                    ...
                    <div class="ec-cat-list card card-default mb-24px">
                        <div class="card-body">
                            <div class="ec-cat-form">
                                ...
                                <form class="row" action="{{route('category.update',$category->id)}}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    @method("PUT")
                                    <div class="form-group col-12 ">
                                        <label for="text" class="col-form-label">Category name</label>
                                        <input id="text" name="name" value="{{$category->name}}" class="form-control here slug-title"
                                            type="text" />
                                    </div>
                                    <div class="form-group col-12 ">
                                    ...
                                    <div class="form-group col-12 ">
                                        ...
                                        <div class="col-12 d-flex">
                                            <span>Published<input type="radio"  {{$category->status==1?"checked":""}} name="status" value="1" /></span>
                                            <span>UnPublished<input type="radio" {{$category->status==0?"checked":""}} name="status" value="0" /></span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">

                            ...
                            <div class="ec-vendor-upload-detail">
                                <form class="row g-3" action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control slug-title" name="name" placeholder="Product Name" id="" />
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control slug-title" name="code" placeholder="Product Name" id="" />
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputEmail7" class="form-label">Short Description</label>
                                        <textarea class="form-control"  name="shot_description" placeholder="Short Description" id=""></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputEmail8" class="form-label">Long Description</label>
                                        <textarea class="form-control " name="long_description" placeholder="Long Description" id=""></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputEmail9" class="form-label">Meta Title</label>
                                        <input type="text" class="form-control " name="meta_title" placeholder="Meta Title" id="" />
                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputEmail0" class="form-label">Meta Description</label>
                                        <textarea class="form-control " name="meta_description" placeholder="Long Description" id=""></textarea>

                                    </div>
                                    <div class="col-md-6">
                                        <label for="inputEmail11" class="form-label">Regular Price</label>
                                        <input type="number" class="form-control " name="regular_price" placeholder="Regular Price" id="" />
                                    </div>
                                    <div class="col-md-6">

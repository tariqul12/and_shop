...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Mar 2024 19:38:04 GMT -->
<head>
		<meta charset="utf-8" />
								...
								<div class="login_form_wrapper">
									<form action="{{route('register')}}" method="POST">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" name="name" required autofocus placeholder="Enter username">
										</div>
										<div class="form-group">
                                        ...
                                        <div class="form-group">
											...
											<input type="password" class="form-control" name="password_confirmation" required placeholder="Enter password">
										</div>
										...
										<div class="login_form_bottm_area">
											...
											<a href="{{route('login')}}" class="btn custom_button w-100">Login</a>
										</div>
									</form>
								</div>
							</div>
